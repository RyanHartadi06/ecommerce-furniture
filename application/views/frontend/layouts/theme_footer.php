      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <ul class="footer_payment text-center text-md-right">
            <li><a href="#"><img src="<?= base_url('assets/frontend/images/visa.png') ?>" alt="visa"></a></li>
            <li><a href="#"><img src="<?= base_url('assets/frontend/images/discover.png') ?>" alt="discover"></a></li>
            <li><a href="#"><img src="<?= base_url('assets/frontend/images/master_card.png') ?>"
                  alt="master_card"></a></li>
            <li><a href="#"><img src="<?= base_url('assets/frontend/images/paypal.png') ?>" alt="paypal"></a></li>
            <li><a href="#"><img src="<?= base_url('assets/frontend/images/amarican_express.png') ?>"
