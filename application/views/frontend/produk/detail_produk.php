      ...
      <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
        <div class="product-image">
          <div class="product_img_box">
            <img id="product_img" src='<?= base_url('assets/frontend/images/product_img1.jpg') ?>'
              data-zoom-image="<?= base_url('assets/frontend/images/product_zoom_img1.jpg') ?>" alt="product_img1" />
          ...
          <div id="pr_item_gallery" class="product_gallery_item slick_slider" data-slides-to-show="4"
            ...
            <div class="item">
              <a href="#" class="product_gallery_item active" data-image="<?= base_url('assets/frontend/images/product_img1.jpg') ?>"
                data-zoom-image="<?= base_url('assets/frontend/images/product_zoom_img1.jpg') ?>">
                <img src="<?= base_url('assets/frontend/images/product_small_img1.jpg') ?>" alt="product_small_img1" />
              </a>
            </div>
            <div class="item">
              <a href="#" class="product_gallery_item" data-image="<?= base_url('assets/frontend/images/product_img1-2.jpg') ?>"
                data-zoom-image="<?= base_url('assets/frontend/images/product_zoom_img2.jpg') ?>">
                <img src="<?= base_url('assets/frontend/images/product_small_img2.jpg') ?>" alt="product_small_img2" />
              </a>
            </div>
            <div class="item">
              <a href="#" class="product_gallery_item" data-image="<?= base_url('assets/frontend/images/product_img1-3.jpg') ?>"
                data-zoom-image="<?= base_url('assets/frontend/images/product_zoom_img3.jpg') ?>">
                <img src="<?= base_url('assets/frontend/images/product_small_img3.jpg') ?>" alt="product_small_img3" />
              </a>
            </div>
            <div class="item">
              <a href="#" class="product_gallery_item" data-image="<?= base_url('assets/frontend/images/product_img1-4.jpg') ?>"
                data-zoom-image="<?= base_url('assets/frontend/images/product_zoom_img4.jpg') ?>">
                <img src="<?= base_url('assets/frontend/images/product_small_img4.jpg') ?>" alt="product_small_img4" />
              </a>
            </div>
          </div>
        </div>
        ...
        <div class="releted_product_slider carousel_slider owl-carousel owl-theme" data-margin="20"
            ...
            <div class="product">
              <div class="product_img">
                <a href="shop-product-detail.html">
                  <img src="<?= base_url('assets/frontend/images/product_img1.jpg') ?>" alt="product_img1">
                </a>
          ...
          <div class="item">
            <div class="product">
              <div class="product_img">
                <a href="shop-product-detail.html">
                  <img src="<?= base_url('assets/frontend/images/product_img2.jpg') ?>" alt="product_img2">
                </a>
                <div class="product_action_box">
                  <ul class="list_none pr_action_btn">
                    <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
          ...
          <div class="item">
            <div class="product">
              ...
              <div class="product_img">
                <a href="shop-product-detail.html">
                  <img src="<?= base_url('assets/frontend/images/product_img3.jpg') ?>" alt="product_img3">
                </a>
                <div class="product_action_box">
                  <ul class="list_none pr_action_btn">
                    <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
          ...
          <div class="item">
            <div class="product">
              <div class="product_img">
                <a href="shop-product-detail.html">
                  <img src="<?= base_url('assets/frontend/images/product_img4.jpg') ?>" alt="product_img4">
                </a>
                <div class="product_action_box">
                  <ul class="list_none pr_action_btn">
                    <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
          ...
          <div class="item">
            <div class="product">
              <div class="product_img">
                <a href="shop-product-detail.html">
                  <img src="<?= base_url('assets/frontend/images/product_img5.jpg') ?>" alt="product_img5">
                </a>
                <div class="product_action_box">
                  <ul class="list_none pr_action_btn">
                    <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
