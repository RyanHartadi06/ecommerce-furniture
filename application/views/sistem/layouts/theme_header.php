<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
    <a class="navbar-brand brand-logo mr-5" href="<?= site_url('Home') ?>"><img style="height: 43px !important;" src="<?= base_url('assets/images/logo-admin.png') ?>" class="mr-2" alt="logo"/></a>
    <a class="navbar-brand brand-logo-mini" href="<?= site_url('Home') ?>"><img src="<?= base_url('assets/images/logo-tahfiz.png') ?>" alt="logo"/></a>
  </div>
