        ...
        foreach ($list->result() as $row) { $no++; ?>
          <tr>
            ...
            <td class="text-center">
              <a href="javascript:;" data-id="<?=$row->id?>" data-name="<?=$row->nama_pelanggan?>" class="btn btn-sm btn-info btn-detail" data-toggle="tooltip" title="Detail Order"><i class="fa fa-eye"></i></a>	    
